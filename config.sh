...
#   Discord:    DISCORD_ALERTS, DISCORD_NOTIFICATIONS, DISCORD_DESC_LIMIT
#   Paths:      KOMETA_CONFIG, METADATA_DIR, SCRIPTS_DIR, LOG_DIR, REPORT_DIR,
#               REPORTS_DIR, MOVIES_DIR, TV_DIR, BACKUP_DIR,
...
#   Retention:  RETENTION_DAYS (+ aliases: RETENTION_LOGS_DAYS, RETENTION_BACKUPS_DAYS,
#               RETENTION_UMTK_LOGS_DAYS, RETENTION_PTS_DAYS)
